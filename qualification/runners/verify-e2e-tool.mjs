...
//
// It used to be the literal `'D:/DSH/work/dsh-native-daily/qualification/results/M8.5-c2-real-boot/e2e-tool.json'`.
...
//
// `import.meta.url` is `.../qualification/runners/verify-e2e-tool.mjs`, so two levels up is the
...
// describes. `E2E_OUT` still overrides for an explicit target.
// ---------------------------------------------------------------------------
...
const OUT = process.env.E2E_OUT ?? join(REPO_ROOT, 'qualification/results/M8.5-c2-real-boot/e2e-tool.json')
