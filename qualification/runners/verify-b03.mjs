...
//
// It used to be the literal `'D:/DSH/work/dsh-native-daily/qualification/results/M9.18-b03-lifecycle/b03.json'`.
...
//
// `import.meta.url` is `.../qualification/runners/verify-b03.mjs`, so two levels up is the
...
// describes. `B03_OUT` still overrides for an explicit target.
// ---------------------------------------------------------------------------
...
const OUT = process.env.B03_OUT ?? join(REPO_ROOT, 'qualification/results/M9.18-b03-lifecycle/b03.json')
