...
//
// It used to be the literal `'D:/DSH/work/dsh-native-daily/qualification/results/M9.17-b02-resolver/b02.json'`.
...
//
// `import.meta.url` is `.../qualification/runners/verify-b02.mjs`, so two levels up is the
...
// describes. `B02_OUT` still overrides for an explicit target.
// ---------------------------------------------------------------------------
...
const OUT = process.env.B02_OUT ?? join(REPO_ROOT, 'qualification/results/M9.17-b02-resolver/b02.json')
 ...
 */
const EXTENSION = join(REPO_ROOT, 'packages/dsh-daily-work/package.json')
