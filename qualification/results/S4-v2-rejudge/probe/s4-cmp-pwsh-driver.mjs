...
const RUN_DIR = `${REPO}/qualification/results/S4-v2-rejudge/runs/cmp-pwsh-control`
const OUT = `${RUN_DIR}/probe.json`
const OVERLAY = `${REPO}/qualification/results/S4-v2-rejudge/probe/s4-cmp-pwsh-overlay.yml`
