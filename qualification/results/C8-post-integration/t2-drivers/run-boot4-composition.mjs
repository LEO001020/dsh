...
const PROFILE = 'daily'
const OUT = `${REPO}/qualification/results/C8-post-integration/boot4-composition.json`
const OVERLAY = `${REPO}/qualification/runners/verify-cmp-composition.patch.yml`
const TRANSCRIPT = `${REPO}/qualification/results/C8-post-integration/boot4-transcript.txt`
...
writeFileSync(`${REPO}/qualification/results/C8-post-integration/boot4-verdict.json`, `${JSON.stringify(verdict, null, 2)}\n`, 'utf8')
